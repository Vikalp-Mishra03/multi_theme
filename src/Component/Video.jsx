        ...
        <Stack direction={['column', 'row']} h={'100vh'}>
            <VStack w={'full'}>
                ...
                <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
                    ...
                    <Text fontFamily={'cursive'}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum optio, recusandae corporis debitis dolorem eveniet natus adipisci sint voluptas nulla neque atque at, officia, ullam minima nostrum est sunt nemo doloremque hic facere consequuntur. Eos numquam modi accusantium vero quibusdam ipsa quis dicta tenetur mollitia error. Praesentium officiis perferendis quo. Nostrum delectus quam, neque sapiente quod voluptate obcaecati impedit quo sunt, soluta praesentium aliquid molestiae, omnis quos tenetur temporibus rem maxime voluptatum commodi reiciendis tempora illo. Quo iusto soluta recusandae! Molestiae neque, sed dolorem exercitationem quae libero animi, sapiente fugiat vero dolorum harum, voluptatum error atque mollitia earum rem velit.</Text>
                </VStack>
            </VStack>
